...
// ── poetic anonymized handles (for demo; evocative, polite) ───────────────────
const H_PREFIX = [
  "晚風", "月下", "晨霧", "霜降", "流光", "聽雨", "暮色", "深夜", "半窗", "燈下",
  "向晚", "煙雨", "星夜", "微光", "薄暮", "初雪", "拂曉", "簷下", "枕書", "汐止",
];
const H_ROLE = [
  "讀書人", "抄經人", "拾光者", "聽風者", "煮字人", "伏案者", "觀星者", "賞花人",
  "品茗者", "夜行人", "過客", "筆耕者", "尋夢人", "漫遊者", "看雲的人", "數雨的人",
  "踏雪人", "倚窗者", "拾穗者", "守燈人",
];
